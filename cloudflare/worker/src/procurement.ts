...
const FIXED_SOURCES = Object.freeze({
  ...
  lirongSheets: ["工作表1"],
  seasonalSalesFolderId: "1EJulxKDjDpq6o7Gc_-F8SFG8r8IqyCA7",
  seasonalDraftFolderId: "1NX47WCCEvf2bLH2HUiDvnrRDfFuWudTz",
  seasonalApprovedFolderId: "1ZUG_f_wNSyOOhtECYzCYSXj6DLRiHyo3"
});
